    ...
    <div class="w-full max-w-md">
      <div class="bg-base-100 rounded-2xl shadow-lg p-8">
        <div class="text-center mb-8">
          <!-- Icône d'attente -->
          <div class="w-20 h-20 bg-warning/10 rounded-2xl flex items-center justify-center mx-auto mb-6">
          ...
          <p class="text-base-content/70 leading-relaxed">
            Votre compte administrateur a été créé avec succès, mais il nécessite une approbation par un super administrateur avant de pouvoir accéder au dashboard.
          </p>
        </div>
        ...
        <div class="bg-info/5 border border-info/20 rounded-lg p-4 mb-6">
          <div class="flex items-start space-x-3">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-info mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="mt-6 text-center">
          <button @click="goToHome" class="link link-neutral text-sm">
            ← Retour à l'accueil
          </button>
        </div>

        <!-- Message de statut -->
        <div v-if="statusMessage" class="mt-4 p-3 rounded-lg text-sm" :class="{
