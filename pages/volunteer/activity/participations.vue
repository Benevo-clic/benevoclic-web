        ...
        <div v-else class="text-center py-16">
          <div class="max-w-md mx-auto">
            ...
            <p class="text-base-content opacity-70 mb-8 leading-relaxed">
              ...
              événements disponibles et lancez-vous !
            </p>
          </div>
        </div>
      </div>
...
import { Search, Calendar, MapPin, ClipboardList } from 'lucide-vue-next'
...
async function initData () {
  try {
    ...
    if (getUserId) {
      announcements.value =
        await useVolunteer.getParticipantAnnouncement(getUserId)
    } else {
      console.warn(
