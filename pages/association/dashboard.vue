<script setup lang="ts">
  ...
  const retentionRate = computed(() => {
    ...
    const multiEventVolunteers = Array.from(volunteerParticipation.values()).filter(
      count => count > 1
    ).length
  ...
  >
    ...
    >
      <div class="flex flex-col items-center space-y-4">
        <img src="/logo.png" alt="Chargement…" class="w-16 h-16 sm:w-20 sm:h-20 animate-spin" />
        ...
        >
          <div class="flex items-center justify-between mb-3 sm:mb-4">
            ...
            <div class="text-right min-w-0 flex-1 ml-3">
              <div class="text-xl sm:text-2xl font-bold text-base-content truncate">
                {{ totalAnnouncements }}
              </div>
        ...
        >
          <div class="flex items-center justify-between mb-3 sm:mb-4">
            ...
            <div class="text-right min-w-0 flex-1 ml-3">
              ...
              <div class="text-xs sm:text-sm text-base-content opacity-70 truncate">
                Participants
              </div>
            </div>
          </div>
      ...
      <div class="grid grid-cols-1 xl:grid-cols-2 gap-6 sm:gap-8 mb-6 sm:mb-8">
        ...
        <div class="bg-base-100 rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 min-w-0">
          ...
          <div class="space-y-3 sm:space-y-4 max-h-96 overflow-y-auto overflow-x-hidden">
            ...
            >
              <ObjectiveProgress :title="obj.title" :covered="obj.covered" :planned="obj.planned" />
            </div>
          </div>
        </div>
