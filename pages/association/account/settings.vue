  ...
  <div class="min-h-screen bg-base-200">
      ...
      <div class="mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p class="text-base-content/70 mt-2">{{ $t('settings.subtitle_association') }}</p>
          </div>
            ...
            <div class="bg-base-100 rounded-xl shadow-lg border border-base-300 p-6">
              <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p class="text-base-content/70">{{ $t('settings.notifications.description_association') }}</p>
                </div>
              </div>
              ...
              <div class="space-y-6">
                <div class="form-control">
                  <label class="label cursor-pointer justify-between">
                    <div>
                      ...
                      <p class="text-xs text-base-content/70">{{ $t('settings.notifications.email_description_association') }}</p>
                    </div>
                    <input 
                      type="checkbox" 
                ...
                <div class="form-control">
                  <label class="label cursor-pointer justify-between">
                    <div>
                      <span class="label-text font-medium">{{ $t('settings.notifications.volunteer_requests') }}</span>
                      <p class="text-xs text-base-content/70">{{ $t('settings.notifications.volunteer_requests_description') }}</p>
                    </div>
                    <input 
                      type="checkbox" 
                ...
                <div class="form-control">
                  <label class="label cursor-pointer justify-between">
                    <div>
                      <span class="label-text font-medium">{{ $t('settings.notifications.event_updates') }}</span>
                      <p class="text-xs text-base-content/70">{{ $t('settings.notifications.event_updates_description') }}</p>
                    </div>
                    <input 
                      type="checkbox" 
                ...
                <div class="form-control">
                  <label class="label cursor-pointer justify-between">
                    <div>
                      <span class="label-text font-medium">{{ $t('settings.notifications.analytics') }}</span>
                      <p class="text-xs text-base-content/70">{{ $t('settings.notifications.analytics_description') }}</p>
                    </div>
                    <input 
                      type="checkbox" 
            ...
            <div class="bg-base-100 rounded-xl shadow-lg border border-base-300 p-6">
              <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p class="text-base-content/70">{{ $t('settings.privacy.description_association') }}</p>
                </div>
              </div>
              ...
              <div class="space-y-6">
                <div class="form-control">
                  <label class="label cursor-pointer justify-between">
                    <div>
                      ...
                      <p class="text-xs text-base-content/70">{{ $t('settings.privacy.profile_visibility_description_association') }}</p>
                    </div>
                    <input 
                      type="checkbox" 
                ...
                <div class="form-control">
                  <label class="label cursor-pointer justify-between">
                    <div>
                      <span class="label-text font-medium">{{ $t('settings.privacy.contact_info') }}</span>
                      <p class="text-xs text-base-content/70">{{ $t('settings.privacy.contact_info_description') }}</p>
                    </div>
                    <input 
                      type="checkbox" 
                ...
                <div class="form-control">
                  <label class="label cursor-pointer justify-between">
                    <div>
                      <span class="label-text font-medium">{{ $t('settings.privacy.event_visibility') }}</span>
                      <p class="text-xs text-base-content/70">{{ $t('settings.privacy.event_visibility_description') }}</p>
                    </div>
                    <input 
                      type="checkbox" 
                ...
                <div class="form-control">
                  <label class="label cursor-pointer justify-between">
                    <div>
                      <span class="label-text font-medium">{{ $t('settings.privacy.volunteer_list') }}</span>
                      <p class="text-xs text-base-content/70">{{ $t('settings.privacy.volunteer_list_description') }}</p>
                    </div>
                    <input 
                      type="checkbox" 
            ...
            <div class="bg-base-100 rounded-xl shadow-lg border border-base-300 p-6">
              <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p class="text-base-content/70">{{ $t('settings.account.description_association') }}</p>
                </div>
              </div>
              ...
              <div class="space-y-6">
                ...
                <div class="bg-base-200 rounded-lg p-4">
                  <div class="flex items-center justify-between">
                    <div>
                      <h3 class="font-medium text-base-content">{{ $t('settings.account.association_info') }}</h3>
                      <p class="text-sm text-base-content/70">{{ $t('settings.account.association_info_description') }}</p>
                    </div>
                    <button 
                ...
                <div class="bg-base-200 rounded-lg p-4">
                  <div class="flex items-center justify-between">
                    <div>
                      ...
                      <p class="text-sm text-base-content/70">{{ $t('settings.account.delete_account_description_association') }}</p>
                    </div>
                    <button 
            ...
            <div class="bg-base-100 rounded-xl shadow-lg border border-base-300 p-6">
              <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p class="text-base-content/70">{{ $t('settings.security.description_association') }}</p>
                </div>
              </div>
              ...
              <div class="space-y-6">
                ...
                <div class="form-control">
                  <label class="label cursor-pointer justify-between">
                    <div>
                      <span class="label-text font-medium">{{ $t('settings.security.siret_verification') }}</span>
                      <p class="text-xs text-base-content/70">{{ $t('settings.security.siret_verification_description') }}</p>
                    </div>
                    <input 
                      type="checkbox" 
          ...
          <div v-else-if="activeSection === 'organization'" class="space-y-6">
            <div class="bg-base-100 rounded-xl shadow-lg border border-base-300 p-6">
              <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 class="text-xl font-semibold text-base-content">{{ $t('settings.organization.title') }}</h2>
                  <p class="text-base-content/70">{{ $t('settings.organization.description') }}</p>
                </div>
              </div>
              ...
              <div class="space-y-6">
                <div class="form-control">
                  <label class="label cursor-pointer justify-between">
                    <div>
                      <span class="label-text font-medium">{{ $t('settings.organization.auto_approve_volunteers') }}</span>
                      <p class="text-xs text-base-content/70">{{ $t('settings.organization.auto_approve_volunteers_description') }}</p>
                    </div>
                    <input 
                      type="checkbox" 
                ...
                <div class="form-control">
                  <label class="label cursor-pointer justify-between">
                    <div>
                      <span class="label-text font-medium">{{ $t('settings.organization.volunteer_limits') }}</span>
                      <p class="text-xs text-base-content/70">{{ $t('settings.organization.volunteer_limits_description') }}</p>
                    </div>
                    <input 
                      type="checkbox" 
                ...
                <div class="form-control">
                  <label class="label cursor-pointer justify-between">
                    <div>
                      <span class="label-text font-medium">{{ $t('settings.organization.event_approval') }}</span>
                      <p class="text-xs text-base-content/70">{{ $t('settings.organization.event_approval_description') }}</p>
                    </div>
                    <input 
                      type="checkbox" 
    ...
    <dialog ref="deleteConfirmationModal" class="modal">
      <div class="modal-box">
        ...
        <p class="py-4 text-base-content/70">{{ $t('settings.delete_confirmation.message_association') }}</p>
