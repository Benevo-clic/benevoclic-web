<template>
  <div class="container mx-auto px-4 py-8 max-w-4xl">
    ...
    <div class="bg-base-100 rounded-xl shadow-lg p-6 mb-6">
      ...
      <div class="space-y-4">
        ...
        <div>
          ...
          <p>
            <a href="mailto:contact@www.benevoclic.fr" class="text-primary hover:underline"
              >contact@www.benevoclic.fr</a
            >
          </p>
        </div>
    ...
    <div class="bg-base-100 rounded-xl shadow-lg p-6 mb-6">
      ...
      <p class="mb-4">
        L'ensemble du contenu du site Benevoclic (images, textes, vidéos, etc.) est protégé par les
        lois relatives à la propriété intellectuelle. Toute reproduction, représentation,
    ...
    <div class="bg-base-100 rounded-xl shadow-lg p-6 mb-6">
      ...
      <p class="mb-4">
        Le site Benevoclic peut contenir des liens hypertextes vers d'autres sites internet ou
        applications. Benevoclic n'exerce aucun contrôle sur ces sites et applications et décline
    ...
    <div class="bg-base-100 rounded-xl shadow-lg p-6">
      ...
      <p>
        Pour toute question relative à l'application des présentes mentions légales, vous pouvez
...
<script setup lang="ts">
  ...
  useHead({
    title: 'Mentions Légales - Benevoclic',
    meta: [
      {
        name: 'description',
        content:
          'Mentions légales de Benevoclic, application de mise en relation entre associations et bénévoles.'
      }
    ]
  })
</script>
