...
describe('Index', () => {
  it('should render the main container and skip link', () => {
    ...
    expect(wrapper.find('a[href="#main-content"]').attributes('aria-label')).toBe(
      'Passer au contenu principal'
    )
  })
  ...
  it('should render the search section with all elements', () => {
    ...
    expect(searchSection.find('input[type="text"]').attributes('placeholder')).toBe(
      "Rechercher par nom d'événement, description, nom d'association..."
    )
