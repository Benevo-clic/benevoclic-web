...
describe("MentionsLegales", () => {
  describe("Rendu de base", () => {
    it("should render mentions legales page", () => {
      ...
      expect(
        wrapper.find(".container.mx-auto.px-4.py-8.max-w-4xl").exists(),
      ).toBe(true);
    });
  ...
  describe("Section Informations générales", () => {
    ...
    it("should render responsible person", () => {
      ...
      const h3s = wrapper.findAll("h3");
      const responsible = h3s.find((el) =>
        el.text().includes("Responsable de publication"),
      );
      expect(responsible).toBeDefined();

      // Chercher le paragraphe correspondant
      const paragraphs = wrapper.findAll("p");
      const responsibleValue = paragraphs.find(
        (el) => el.text() === "Aboubakar Diakité",
      );
    ...
    it("should render contact information", () => {
      ...
      const contactLink = links.find(
        (el) => el.text() === "contact@www.benevoclic.fr",
      );
      expect(contactLink).toBeDefined();
      expect(contactLink.attributes("href")).toBe(
        "mailto:contact@www.benevoclic.fr",
      );
    });
    ...
    it("should render structure type", () => {
      ...
      const h3s = wrapper.findAll("h3");
      const structureType = h3s.find((el) =>
        el.text().includes("Type de structure"),
      );
      expect(structureType).toBeDefined();

      // Chercher le paragraphe correspondant
      const paragraphs = wrapper.findAll("p");
      const structureValue = paragraphs.find((el) =>
        el
          .text()
          .includes("Application web pour la gestion de missions associatives"),
      );
  ...
  describe("Section Hébergement", () => {
    ...
    it("should render address information", () => {
      ...
      const paragraphs = wrapper.findAll("p");
      const addressParagraphs = paragraphs.filter(
        (p) =>
  ...
  describe("Section Propriété intellectuelle", () => {
    ...
    it("should render intellectual property content", () => {
      ...
      const paragraphs = wrapper.findAll("p");
      const ipParagraphs = paragraphs.filter(
        (p) =>
  ...
  describe("Section Droit applicable", () => {
    ...
    it("should render applicable law content", () => {
      ...
      const paragraphs = wrapper.findAll("p");
      const lawParagraphs = paragraphs.filter(
        (p) =>
