...
describe('MentionsLegales', () => {
  ...
  describe('Section Informations générales', () => {
    ...
    it('should render structure type', () => {
      ...
      const structureValue = paragraphs.find(el =>
        el.text().includes('Application web pour la gestion de missions associatives')
      )
  ...
  describe('Section Propriété intellectuelle', () => {
    ...
    it('should render intellectual property content', () => {
      ...
      const ipParagraphs = paragraphs.filter(
        p => p.text().includes('propriété intellectuelle') || p.text().includes('contrefaçon')
      )
  ...
  describe('Section Liens hypertextes', () => {
    ...
    it('should render hyperlinks content', () => {
      ...
      const paragraphs = wrapper.findAll('p')
      const linksParagraphs = paragraphs.filter(p => p.text().includes('liens hypertextes'))
  ...
  describe('Section Droit applicable', () => {
    ...
    it('should render applicable law content', () => {
      ...
      const lawParagraphs = paragraphs.filter(
        p => p.text().includes('droit français') || p.text().includes('tribunaux français')
      )
    ...
    it('should render contact email in law section', () => {
      ...
      const contactLinks = links.filter(
        link => link.attributes('href') === 'mailto:contact@www.benevoclic.fr'
      )
