...
describe('VolunteerAccountEdit', () => {
  it('should render the main container', () => {
    ...
    expect(wrapper.find('.flex.flex-col.items-center.justify-center.min-h-screen').exists()).toBe(true)
  })
  ...
  it('should render the personal information section', () => {
    const wrapper = mount(MockVolunteerAccountEdit)
    const personalInfo = wrapper.find('.bg-base-100.rounded-xl.shadow.p-6.grid.grid-cols-1.md\\:grid-cols-2.gap-4')
  ...
  it('should render contact information section', () => {
    const wrapper = mount(MockVolunteerAccountEdit)
    const contactSection = wrapper.findAll('.bg-base-100.rounded-xl.shadow.p-6.grid.grid-cols-1.md\\:grid-cols-2.gap-4')[1]
  ...
  it('should render location information section', () => {
    const wrapper = mount(MockVolunteerAccountEdit)
    const locationSection = wrapper.findAll('.bg-base-100.rounded-xl.shadow.p-6.grid.grid-cols-1.md\\:grid-cols-2.gap-4')[2]
