...
describe("VolunteerAccountProfile", () => {
  ...
  it("should render the profile header section", () => {
    ...
    const headerSection = wrapper.find(
      ".flex.flex-col.items-center.mt-12.mb-6",
    );
  ...
  it("should render the bio description", () => {
    const wrapper = mount(MockVolunteerAccountProfile);
    const bio = wrapper.find(
      ".text-base-content\\/80.text-center.max-w-xl.mb-2",
    );
  ...
  it("should render contact information section", () => {
    const wrapper = mount(MockVolunteerAccountProfile);
    const contactSection = wrapper.find(
      ".bg-base-100.rounded-xl.shadow.p-6.space-y-3",
    );
