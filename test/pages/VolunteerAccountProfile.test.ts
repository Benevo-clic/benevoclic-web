...
describe('VolunteerAccountProfile', () => {
  ...
  it('should render the profile image', () => {
    const wrapper = mount(MockVolunteerAccountProfile)
    const profileImage = wrapper.find('.w-32.h-32.rounded-full.border-4.border-base-100.shadow-lg.bg-base-300')
  ...
  it('should render all statistics cards', () => {
    const wrapper = mount(MockVolunteerAccountProfile)
    const statCards = wrapper.findAll('.bg-base-100.rounded-xl.shadow.p-4.flex.flex-col.items-center')
