...
// Mock des modules
vi.mock('~/components/event/association/ReadOnlyEventList.vue', () => MockReadOnlyEventList)

vi.mock('~/components/event/association/EventFilters.vue', () => MockEventFilters)
...
describe('AssociationManage', () => {
  ...
  describe('Event Filters Section', () => {
    it('should render event filters container', () => {
      const wrapper = mount(MockAssociationManage)
      const filtersContainer = wrapper.find('.bg-base-100.rounded-lg.shadow-md.p-6')
  ...
  describe('Event List Section', () => {
    ...
    it('should render the content card', () => {
      const wrapper = mount(MockAssociationManage)
      const contentCard = wrapper.find('.bg-base-100.rounded-2xl.shadow-md.p-6')
