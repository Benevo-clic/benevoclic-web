...
// Mock component pour tester le composant Announcements
const MockEvents = {
  template: `
    <div class="events">
...
describe("Announcements", () => {
  ...
  describe("Événements vides", () => {
    it("should display no events message when featuredEvents is empty", () => {
      ...
      const noEventsMessage = wrapper
        .findAll("p")
        .find((p) => p.text().includes("Aucun événement à venir"));
      expect(noEventsMessage.exists()).toBe(true);
      expect(noEventsMessage.text()).toContain(
