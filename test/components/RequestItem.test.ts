...
describe('RequestItem', () => {
  ...
  it('should handle long email addresses', () => {
    ...
    expect(emailElement.text()).toBe('very.long.email.address.that.might.break.layout@example.com')
  })
  ...
  it('should handle volunteer with long name', () => {
    ...
    expect(wrapper.find('h3').text()).toBe('Very Long Volunteer Name That Might Break Layout')
  })
  ...
  it('should have proper layout structure', () => {
    ...
    expect(wrapper.find('.flex.gap-3.pt-4.border-t.border-base-300').exists()).toBe(true)
  })
  ...
  it('should handle different volunteer data', () => {
    ...
    expect(wrapper.find('img').attributes('src')).toBe('/images/jane-avatar.jpg')
  })
