...
describe('AnnouncementDetails', () => {
  ...
  it('should display description', () => {
    ...
    expect(wrapper.find('.text-base-content').text()).toBe('This is a test event description')
  })
  ...
  it('should have proper layout structure', () => {
    ...
    expect(wrapper.find('.flex.justify-between.items-center').exists()).toBe(true)
  ...
  it('should have proper tag accessibility', () => {
    ...
    tags.forEach((tag, index) => {
      expect(tag.attributes('aria-label')).toBe(`Tag: ${mockAnnouncement.tags[index]}`)
    })
  })
