...
describe('Statistique', () => {
  ...
  describe('Rendu de base', () => {
    ...
    it('should display description text', () => {
      ...
      expect(description.text()).toContain('Rejoignez notre communauté grandissante')
    })
  })
  ...
  describe('Cartes de statistiques', () => {
    ...
    it('should display events stat card', () => {
      ...
      expect(eventCard.find('.text-xl.font-semibold.mb-2').text()).toBe('Événements')
    ...
    it('should display associations stat card', () => {
      ...
      expect(associationCard.find('.text-xl.font-semibold.mb-2').text()).toBe('Associations')
      expect(associationCard.find('p').text()).toContain('Associations actives')
    })
    ...
    it('should display volunteers stat card', () => {
      ...
      expect(volunteerCard.find('.text-xl.font-semibold.mb-2').text()).toContain('Bénévole')
      expect(volunteerCard.find('p').text()).toContain('bénévoles et participants')
    })
  })
  ...
  describe('Animation et visibilité', () => {
    ...
    it('should have animation delays for cards', () => {
      ...
      const delayedCards = wrapper.findAll('.delay-200, .delay-400, .delay-600')
