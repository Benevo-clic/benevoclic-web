...
describe('useNavigation', () => {
  ...
  describe('Méthode getAccessibleRoutes', () => {
    ...
    it('should return public and volunteer routes for volunteer users', () => {
      ...
      expect(routes).toEqual([...navigation.ROUTE_CONFIG.public, ...navigation.ROUTE_CONFIG.volunteer])
    })
    ...
    it('should return public and association routes for association users', () => {
      ...
      expect(routes).toEqual([...navigation.ROUTE_CONFIG.public, ...navigation.ROUTE_CONFIG.association])
    })
