...
describe('useFavoritesAnnouncement', () => {
  ...
  describe('Méthodes de récupération', () => {
    ...
    it('should call fetchFavoritesByAnnouncementId', async () => {
      ...
      expect(mockFavoriteAnnouncementStore.fetchFavoritesByAnnouncementId).toHaveBeenCalledWith(
        announcementId
      )
    })
    ...
    it('should call fetchAllFavoritesOfVolunteer', async () => {
      ...
      expect(mockFavoriteAnnouncementStore.fetchAllFavoritesOfVolunteer).toHaveBeenCalledWith(
        volunteerId
      )
    })
  ...
  describe('Méthodes de suppression', () => {
    ...
    it('should call removeAllByAnnouncementId', async () => {
      ...
      expect(mockFavoriteAnnouncementStore.removeAllByAnnouncementId).toHaveBeenCalledWith(
        announcementId
      )
    })
