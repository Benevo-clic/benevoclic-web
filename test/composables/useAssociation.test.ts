...
describe('useAssociationAuth', () => {
  ...
  describe('Méthodes de gestion des bénévoles', () => {
    ...
    it('should call removeVolunteerFromAssociation', async () => {
      ...
      expect(mockAssociationStore.removeVolunteerFromAssociation).toHaveBeenCalledWith(volunteerData)
    })
    ...
    it('should call removeAssociationVolunteerWaiting', async () => {
      ...
      expect(mockAssociationStore.removeAssociationVolunteerWaiting).toHaveBeenCalledWith(volunteerData)
    })
  })
