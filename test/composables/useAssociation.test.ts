...
describe("useAssociationAuth", () => {
  ...
  describe("Méthodes d'enregistrement", () => {
    it("should call registerAssociation", async () => {
      ...
      expect(mockAssociationStore.registerAssociation).toHaveBeenCalledWith(
        associationData,
      );
    });
  });
  ...
  describe("Méthodes de récupération", () => {
    ...
    it("should call getAssociationInfo", async () => {
      ...
      expect(mockAssociationStore.getAssociationInfo).toHaveBeenCalledWith(
        associationId,
      );
    });
    ...
    it("should call getAssociationInfoBySiret", async () => {
      ...
      expect(
        mockAssociationStore.getAssociationInfoBySiret,
  ...
  describe("Méthodes de gestion des associations", () => {
    it("should call removeAssociation", async () => {
      ...
      expect(mockAssociationStore.removeAssociation).toHaveBeenCalledWith(
        associationId,
      );
    });
    ...
    it("should call updateAssociation", async () => {
      ...
      expect(mockAssociationStore.updateAssociation).toHaveBeenCalledWith(
        associationData,
      );
    });
  });
  ...
  describe("Méthodes de gestion des bénévoles", () => {
    it("should call addVolunteerToAssociation", async () => {
      ...
      expect(
        mockAssociationStore.addVolunteerToAssociation,
    ...
    it("should call removeVolunteerFromAssociation", async () => {
      ...
      expect(
        mockAssociationStore.removeVolunteerFromAssociation,
      ).toHaveBeenCalledWith(volunteerData);
    });
    ...
    it("should call removeAssociationVolunteerWaiting", async () => {
      ...
      expect(
        mockAssociationStore.removeAssociationVolunteerWaiting,
      ).toHaveBeenCalledWith(volunteerData);
    });
  });
  ...
  describe("Intégration avec le store", () => {
    it("should use association store for all methods", () => {
      ...
      expect(association.registerAssociation).toBe(
        mockAssociationStore.registerAssociation,
      );
      expect(association.getAssociationInfo).toBe(
        mockAssociationStore.getAssociationInfo,
      );
      expect(association.updateAssociation).toBe(
        mockAssociationStore.updateAssociation,
      );
