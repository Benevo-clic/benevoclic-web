...
describe("useVolunteerAuth", () => {
  ...
  describe("Méthodes d'enregistrement", () => {
    it("should call registerVolunteer", async () => {
      ...
      expect(mockVolunteerStore.registerVolunteer).toHaveBeenCalledWith(
        volunteerData,
      );
    });
  });
  ...
  describe("Méthodes de récupération", () => {
    ...
    it("should call getVolunteerInfo", async () => {
      ...
      expect(mockVolunteerStore.getVolunteerInfo).toHaveBeenCalledWith(
        volunteerId,
      );
    });
  });
  ...
  describe("Méthodes de gestion des bénévoles", () => {
    it("should call updateVolunteer", async () => {
      ...
      expect(mockVolunteerStore.updateVolunteer).toHaveBeenCalledWith(
        volunteerData,
      );
    });
    ...
    it("should call removeVolunteer", async () => {
      ...
      expect(mockVolunteerStore.removeVolunteer).toHaveBeenCalledWith(
        volunteerId,
      );
    });
  });
  ...
  describe("Méthodes de gestion des associations", () => {
    it("should call getAssociationToWaitingList", async () => {
      ...
      expect(
        mockVolunteerStore.getAssociationToWaitingList,
    ...
    it("should call removeVolunteerFromWaitingListAssociation", async () => {
      ...
      expect(
        mockVolunteerStore.removeVolunteerFromWaitingListAssociation,
    ...
    it("should call removeVolunteerFromAssociation", async () => {
      ...
      expect(
        mockVolunteerStore.removeVolunteerFromAssociation,
      ).toHaveBeenCalledWith(data);
    });
    ...
    it("should call addVolunteerToWaitingListAssociation", async () => {
      ...
      expect(
        mockVolunteerStore.addVolunteerToWaitingListAssociation,
      ).toHaveBeenCalledWith(data);
    });
  });
  ...
  describe("Méthodes de récupération des associations", () => {
    it("should call getAllAssociationsToWaitingList", async () => {
      ...
      expect(
        mockVolunteerStore.getAllAssociationsToWaitingList,
      ).toHaveBeenCalledWith(volunteerId);
    });
    ...
    it("should call getAllAssociationsFollowingList", async () => {
      ...
      expect(
        mockVolunteerStore.getAllAssociationsFollowingList,
      ).toHaveBeenCalledWith(volunteerId);
    });
    ...
    it("should call getAssociationsFollowingList", async () => {
      ...
      expect(
        mockVolunteerStore.getAssociationsFollowingList,
      ).toHaveBeenCalledWith(volunteerId);
    });
    ...
    it("should call getAssociations", async () => {
      ...
      expect(mockVolunteerStore.getAssociations).toHaveBeenCalledWith(
        volunteerId,
      );
    });
  });
  ...
  describe("Méthodes de récupération des annonces", () => {
    it("should call getVolunteerAnnouncements", async () => {
      ...
      expect(mockVolunteerStore.getVolunteerAnnouncements).toHaveBeenCalledWith(
        volunteerId,
      );
    });
    ...
    it("should call getParticipantAnnouncement", async () => {
      ...
      expect(
        mockVolunteerStore.getParticipantAnnouncement,
      ).toHaveBeenCalledWith(volunteerId);
    });
    ...
    it("should call getPastVolunteerAnnouncement", async () => {
      ...
      expect(
        mockVolunteerStore.getPastVolunteerAnnouncement,
      ).toHaveBeenCalledWith(volunteerId);
    });
  });
  ...
  describe("Intégration avec le store", () => {
    it("should use volunteer store for all methods", () => {
      ...
      expect(volunteer.registerVolunteer).toBe(
        mockVolunteerStore.registerVolunteer,
      );
      expect(volunteer.getVolunteerInfo).toBe(
        mockVolunteerStore.getVolunteerInfo,
      );
      expect(volunteer.updateVolunteer).toBe(
        mockVolunteerStore.updateVolunteer,
      );
      expect(volunteer.getAssociations).toBe(
        mockVolunteerStore.getAssociations,
      );
    });
  ...
  describe("Méthodes utilitaires", () => {
    it("should handle multiple operations", async () => {
      ...
      expect(
        mockVolunteerStore.addVolunteerToWaitingListAssociation,
      ).toHaveBeenCalledWith(associationData);
    });
