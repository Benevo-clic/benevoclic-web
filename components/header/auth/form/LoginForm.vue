...
<template>
  <div class="w-full max-w-md" role="main" aria-labelledby="login-title">
    ...
    <p class="text-base text-gray-600 mb-6" v-if="!isRegisterMode" id="login-description">
      {{t('auth.login.description')}}
    </p>
    <p class="text-base text-gray-600 mb-6" v-else id="register-description">
    ...
    <fieldset class="mb-4">
      ...
      <label class="flex items-center gap-3 cursor-pointer">
        <input
            ...
            :aria-label="isAssociation ? 'Basculer vers mode bénévole' : 'Basculer vers mode association'"
        />
        <span class="text-sm">
    ...
    <div id="google-disabled-reason" class="sr-only" v-if="isRegisterMode && !termsAccepted">
