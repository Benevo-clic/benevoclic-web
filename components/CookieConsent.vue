      ...
      >
        <div class="flex-1">
          ...
          <p class="text-sm text-base-content/80 mb-4 md:mb-0">
            ...
            site. Certains sont nécessaires au fonctionnement du site, tandis
            que d'autres nous aident à comprendre comment vous l'utilisez. Vous
            pouvez accepter tous les cookies ou personnaliser vos préférences.
            <NuxtLink
              to="/confidentialite"
          ...
          <label class="label cursor-pointer justify-start gap-4">
            ...
            <div>
              ...
              <p class="text-xs text-base-content/70 mt-1">
                ...
                peuvent pas être désactivés. Ils permettent notamment de vous
                authentifier et de sécuriser votre navigation.
                <span class="text-warning font-medium">Sans ces cookies, vous ne pourrez pas vous connecter à votre
                  compte.</span>
              </p>
            </div>
          </label>
        ...
        <div class="form-control">
          <label class="label cursor-pointer justify-start gap-4">
            ...
            <div>
              ...
              <p class="text-xs text-base-content/70 mt-1">
                Ces cookies nous permettent de vous proposer des contenus
                adaptés à vos centres d'intérêt, de mémoriser vos préférences
                d'affichage et d'utiliser votre localisation pour des services
                géolocalisés.
                <span class="text-info font-medium">Nécessaire pour la géolocalisation et les données
                  personnelles.</span>
              </p>
            </div>
          </label>
          ...
          <label class="label cursor-pointer justify-start gap-4">
            ...
            <div>
              ...
              <p class="text-xs text-base-content/70 mt-1">
                ...
                et d'améliorer son fonctionnement. Ils sont utilisés par
                Firebase Analytics pour générer des statistiques anonymes.
              </p>
            </div>
          </label>
        </div>
        ...
        <div class="form-control">
          <label class="label cursor-pointer justify-start gap-4">
            ...
            <div>
              ...
              <p class="text-xs text-base-content/70 mt-1">
                Ces cookies sont déposés par des services tiers comme Google
                Fonts ou les réseaux sociaux. Ils permettent notamment
                d'afficher des polices personnalisées et de partager du contenu.
              </p>
            </div>
          </label>
        </div>
      ...
      <div class="space-y-4">
        ...
        <div v-if="!permissions.canUseLocation" class="alert alert-info">
          ...
          <div>
            ...
            <p class="text-sm">
              Acceptez les cookies de personnalisation pour utiliser la
              géolocalisation.
            </p>
          </div>
        </div>
