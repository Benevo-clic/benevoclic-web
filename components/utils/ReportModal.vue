        ...
        <h3 class="text-xl font-bold text-base-content">
          {{
            isAnnouncementReport
              ? translate(
                "help.report.announcement_title",
      ...
      <form class="space-y-6" @submit.prevent="submitReport">
        ...
        <div class="form-control">
          ...
          >
            ...
            <option value="USER_FEEDBACK">
              {{
                translate(
                  "help.report.types.user_feedback",
          ...
          >
            ...
            >
              ...
              <option value="OTHER">
                {{
                  translate(
                    "help.report.categories.announcement.other",
                    "Autre",
                  )
                }}
              </option>
            ...
            >
              ...
              <option value="BUG_REPORT">
                {{
                  translate(
                    "help.report.categories.user_feedback.bug_report",
                    "Signalement de bug",
                  )
                }}
              </option>
              ...
              <option value="OTHER">
                {{
                  translate(
                    "help.report.categories.user_feedback.other",
                    "Autre",
                  )
                }}
              </option>
            ...
            >
              <option value="GENERAL_INQUIRY">
                {{
                  translate(
                    "help.report.categories.other.general_inquiry",
                    "Question générale",
                  )
                }}
              </option>
              <option value="ACCOUNT_ISSUE">
                {{
                  translate(
                    "help.report.categories.other.account_issue",
                    "Problème de compte",
                  )
                }}
              </option>
              ...
              <option value="PRESS_INQUIRY">
                {{
                  translate(
                    "help.report.categories.other.press_inquiry",
                    "Demande de presse",
                  )
                }}
              </option>
        ...
        <div class="form-control">
          ...
          <textarea
            ...
            :placeholder="
              translate(
                'help.report.description_placeholder',
        ...
        <div class="bg-base-200 rounded-lg p-4">
          ...
          <div class="text-sm text-base-content/70 space-y-2">
            ...
            <div v-if="reportForm.announcementId">
              <strong>{{
                translate("help.report.announcement_id", "Annonce ID")
              }}:</strong>
...
const isAnnouncementReport = computed(
  () => reportForm.value.type === 'ANNOUNCEMENT'
)
