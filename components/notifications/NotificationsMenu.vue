<template>
  <div class="bg-base-100 rounded-lg shadow-md p-4" role="region" aria-labelledby="notifications-menu-title">
    <h2 id="notifications-menu-title" class="text-xl font-semibold mb-4 text-base-content">{{ t('drawer-content.notifications_support.title') }}</h2>
