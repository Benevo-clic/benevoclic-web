    ...
    <section v-if="!props.startSearching" id="stats-section" class="py-16 px-4 bg-base-200">
      <div class="max-w-6xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="bg-base-100 p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 text-center slide-in-up delay-200" :class="{ 'visible': props.isVisible }">
