        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          ...
          <div class="absolute top-8 left-0 w-full h-1 bg-base-300 hidden md:block z-0">
            <div class="absolute top-0 left-0 h-full bg-primary transition-all duration-1000"
                 :style="{ width: props.isVisible ? '100%' : '0%' }"></div>
          </div>

          <!-- Étape 1 -->
          <div class="flex flex-col items-center text-center slide-in-up" :class="{ 'visible': props.isVisible }">
          ...
          <!-- Étape 2 -->
          <div class="flex flex-col items-center text-center slide-in-up delay-300" :class="{ 'visible': props.isVisible  }">
          ...
          <!-- Étape 3 -->
          <div class="flex flex-col items-center text-center slide-in-up delay-600" :class="{ 'visible': props.isVisible  }">
